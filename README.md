...
A lightweight, modern, and responsive web-based dashboard designed to monitor your home network status in real-time. This project is built with minimal resource consumption in mind, making it ideal for running directly on **OpenWrt routers** or within **Proxmox LXC containers** in a homelab environment. It also has a nice Mobile/Tablet friendly UI.
...
## 📸 Screenshots
<p align="center">
  <img src="https://raw.githubusercontent.com/PacoSLO/openWRT-NOC-/refs/heads/main/noc.png" alt="OpenWrt NOC Dashboard Preview" width="900">
</p>
